  ...
  return (
    <>
      {!isCameraTravelling && (
        <div
          id='resource'
          className='bg-primary fadeIn flex-1 pointer-events-auto px-10 md:px-14 py-5 md:py-7 ml-24 lg:ml-80 rounded-2xl w-full max-w-md md:max-w-xl max-h-96 md:max-h-80'
        >
